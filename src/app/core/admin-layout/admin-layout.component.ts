...
export class AdminLayoutComponent implements OnInit, OnDestroy {
  ...
  public menuList = [
    { 'url': '/employee-management', 'img': 'employee-management', 'name': 'Employee' },
    { 'url': '/group-management', 'img': 'group-management', 'name': 'Group' },
    { 'url': '/program-management', 'img': 'program-management', 'name': 'Program' }];
  constructor(
